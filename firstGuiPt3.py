...
def adminHub(userID):
    ...
    browseSwipe = Button(frame_swipe, text="Browse Swipe History 💳", padx=56, pady=30, fg="brown", command=browseHistory)
    browseSwipe.pack(side="top", anchor="center", pady=10)

    browseName = Button(frame_swipe, text="Browse by Name 🤓", padx=70, pady=30, fg="brown", command= lambda: searchName(userID))
    ...
    swipe_out_button = Button(frame_swipe, text="Swipe Out ❌", padx=89, pady=30,fg= "red", bg="black", command=lambda: ActivateSwipeOut(userID))
